...
export const features: Feature[] = [
  ...
  {
    "id": "app-connectors-aws-athena-and-replicate",
    "icon": "✨",
    "name": "App connectors: AWS Athena and Replicate",
    "source": "https://lovable.dev/changelog",
    "status": "Beta",
    "pricing": "All plans",
    "tagline": "New app connectors for data querying and AI model running.",
    "category": "App Connectors",
    "useCases": [],
    "description": "Two new app connectors enable your apps to query data in Amazon S3 using SQL and run open-source AI models for various media generation tasks. AWS Athena allows seamless integration with your database while Replicate offers a library of AI models.",
    "releaseDate": "2026-06-01",
    "capabilities": [
      ...
      "Fosters advanced app functionalities"
    ]
  },
  {
  ...
  {
    "id": "app-connectors-algolia-linkedin-and-microsoft-sharepoint",
    "icon": "✨",
    "name": "App connectors: Algolia, LinkedIn, and Microsoft SharePoint",
    "source": "https://lovable.dev/changelog",
    "status": "Beta",
    "pricing": "All plans",
    "tagline": "Third-party app connectors for advanced functionalities.",
    "category": "App Connectors",
    "useCases": [],
    "description": "Three new app connectors have been introduced that allow enhanced functionalities including search capabilities via Algolia, LinkedIn posting workflows, and Microsoft SharePoint content integration. These connectors enable admins and owners to configure their apps seamlessly.",
    "releaseDate": "2026-05-28",
    "capabilities": [
      "Fast, typo-tolerant search",
      "LinkedIn integration for posts",
  ...
  {
    "id": "app-connectors-airtable-attention-brevo-google-search-consol",
    "icon": "✨",
    "name": "App connectors: Airtable, Attention, Brevo, Google Search Console, Granola, Mailgun, Notion, Storyblok",
    "source": "https://lovable.dev/changelog",
    "status": "Beta",
    "pricing": "All plans",
    "tagline": "Integrate your apps with more services for enhanced functionality.",
    "category": "App Connectors",
    "useCases": [],
    "description": "New app connectors enable integration with various services, expanding Lovable's capabilities. These connectors facilitate interactions with external tools, making it easier to build sophisticated applications.",
    "releaseDate": "2026-05-18",
    "capabilities": [
      "Access Airtable data",
      "Manage customer conversations with Attention",
      "Send transactional emails using Brevo",
      "Connect to Google Search Console",
      "Streamline meeting data through Granola",
      "Integrate with Notion and Storyblok for content management"
    ]
  },
  {
  ...
  {
    "id": "chat-connectors-heygen",
    "icon": "✨",
    "name": "Chat connectors: HeyGen",
    "source": "https://lovable.dev/changelog",
    "status": "Beta",
    "pricing": "All plans",
    "tagline": "Leverage HeyGen's capabilities for enhanced app features.",
    "category": "Editor",
    "useCases": [],
    "description": "HeyGen is now available as a prebuilt chat connector, allowing the Lovable agent to utilize avatars, voices, and video generation tools during app creation, enhancing user engagement and interactivity.",
    "releaseDate": "2026-05-18",
    "capabilities": [
      "Integrate avatars and voices",
      "Generate personalized onboarding",
      "Create media-rich demos",
      "Utilize video generation tools",
      "Streamline app workflows with artificial intelligence",
  ...
  {
    "id": "app-connectors-airtable-brevo-notion",
    "icon": "✨",
    "name": "App connectors: Airtable, Brevo, Notion",
    "source": "https://lovable.dev/changelog",
    "status": "Beta",
    "pricing": "All plans",
    "tagline": "Enhance app functionality with new connectors.",
    "category": "App Connectors",
    "useCases": [],
    "description": "New app connectors enrich Lovable's integration capabilities, allowing users to interact with Airtable, Brevo, and Notion for data management, email communications, and content structure. This integration allows for direct access to external data within Lovable development.",
    "releaseDate": "2026-05-17",
    "capabilities": [
      "Flexible data management",
      "Email marketing integration",
      "Content structuring capabilities",
      "Seamless app interactions",
      "Enhanced service offerings",
      "Supports operational workflows"
    ]
  },
  {
    "id": "chat-connectors-hex-confidence-and-posthog",
    "icon": "✨",
    "name": "Chat connectors: Hex, Confidence, and PostHog",
    "source": "https://lovable.dev/changelog",
    "status": "Beta",
    "pricing": "All plans",
    "tagline": "Integrate product analytics and feedback directly into Lovable.",
    "category": "Editor",
    "useCases": [],
    "description": "Three new chat connectors allow Lovable to access Hex workspaces, integrate feature flags from Confidence, and utilize analytics from PostHog. This improves responsiveness and decision-making in app development based on real usage data and experiment results.",
    "releaseDate": "2026-05-16",
    "capabilities": [
      "Direct access to analytics",
      "Improved feature flag management",
      "Support for user insights",
  ...
  {
    "id": "app-connectors-slack-google-workspace-microsoft-365",
    "icon": "✨",
    "name": "App connectors: Slack, Google Workspace, Microsoft 365",
    "source": "https://lovable.dev/changelog",
    "status": "Beta",
    "pricing": "All plans",
    "tagline": "Streamline communication with essential integrations.",
    "category": "App Connectors",
    "useCases": [],
    "description": "New app connectors for Slack, Google Workspace, and Microsoft 365 enhance communication and productivity within Lovable by allowing direct access to communication tools and essential productivity applications. This integration helps centralize workflows in an accessible environment.",
    "releaseDate": "2026-05-15",
    "capabilities": [
      "Communication integration",
      "Enhanced team collaboration",
      "Access to productivity tools",
      "Empowers quick project updates",
      "Direct communication within Lovable",
  ...
  {
    "id": "app-connectors-google-maps-platform-semrush-and-tiktok",
    "icon": "✨",
    "name": "App connectors: Google Maps Platform, Semrush, and TikTok",
    "source": "https://lovable.dev/changelog",
    "status": "Beta",
    "pricing": "All plans",
    "tagline": "Integrate key services directly into your apps.",
    "category": "App Connectors",
    "useCases": [],
    "description": "Introducing three new app connectors that allow apps to interface with Google Maps, Semrush, and TikTok. These connectors help improve app functionality by integrating mapping solutions, SEO data, and social media insights directly.",
    "releaseDate": "2026-05-01",
    "capabilities": [
      "Integrate Google Maps APIs for location services",
      "Use Semrush for SEO analytics and reporting",
      "Access TikTok data for platform insights",
      "Seamless configuration by workspace admins",
      "Enhance app features with external data"
    ]
  },
  {
    "id": "branded-app-urls",
  ...
  {
    "id": "business-app-connectors-asana-ashby-hubspot",
    "icon": "✨",
    "name": "Business app connectors: Asana, Ashby, HubSpot",
    "source": "https://lovable.dev/changelog",
    "status": "Beta",
    "pricing": "All plans",
    "tagline": "Integrate with business systems to enhance your workflows.",
    "category": "App Connectors",
    "useCases": [],
    "description": "By integrating with Asana, Ashby, and HubSpot, Lovable expands its capabilities for task management, recruiting, and CRM workflows. Users can automate project tasks and gain insights into recruitment and customer relationship management without leaving their development environment.",
    "releaseDate": "2026-04-24",
    "capabilities": [
      "Integrate with Asana for task management",
      "Connect with Ashby for recruitment workflows",
      "Use HubSpot for CRM tools",
      "Automate project management",
      "Leverage data from popular tools",
  ...
  {
    "id": "data-app-connectors-bigquery-databricks-snowflake",
    "icon": "✨",
    "name": "Data app connectors: BigQuery, Databricks, Snowflake",
    "source": "https://lovable.dev/changelog",
    "status": "Beta",
    "pricing": "All plans",
    "tagline": "Connect easily to popular data warehouse platforms.",
    "category": "App Connectors",
    "useCases": [],
    "description": "With new connectors for BigQuery, Databricks, and Snowflake, Lovable users can seamlessly integrate with these data warehouse platforms. This allows builders to create dashboards, analytics features, and internal tools directly utilizing the data their teams trust, enhancing data-driven decision-making in their applications.",
    "releaseDate": "2026-04-24",
    "capabilities": [
      "Connect to BigQuery",
      ...
      "Supports internal data workflows",
      "Compatible with Lovable's architecture"
    ]
  },
  {
    "id": "data-connectors",
    ...
    "description": "Connect to BigQuery, Databricks, and Snowflake for SQL queries and data workflows directly from the Lovable agent.",
    "releaseDate": "2026-04-24",
    "capabilities": [
  ...
  {
    "id": "email-and-workflow-app-connectors-inngest-resend",
    "icon": "✨",
    "name": "Email and workflow app connectors: Inngest, Resend",
    "source": "https://lovable.dev/changelog",
    "status": "Beta",
    "pricing": "All plans",
    "tagline": "Connect your apps to enable powerful email integrations.",
    "category": "App Connectors",
    "useCases": [],
    "description": "New app connectors for Inngest and Resend enable users to incorporate background workflows and email delivery systems into their functions. Enhanced notification systems can now be set up easily through these integrations, improving user engagement and interaction.",
    "releaseDate": "2026-04-24",
    "capabilities": [
      "Integrate with Inngest for workflows",
      "Connect to Resend for email delivery",
      "Automate background tasks",
      "Send transactional emails",
      "Manage marketing communications",
      "Available for all Lovable users"
    ]
  },
  {
  ...
  {
    "id": "knowledge-and-content-app-connectors-fireflies-gemini-enterp",
    "icon": "✨",
    "name": "Knowledge and content app connectors: Fireflies, Gemini Enterprise, WordPress",
    "source": "https://lovable.dev/changelog",
    "status": "Beta",
    "pricing": "All plans",
    "tagline": "Integrate external knowledge sources into your apps.",
    "category": "App Connectors",
    "useCases": [],
    "description": "The capability to connect with Fireflies, Gemini Enterprise, and WordPress allows developers to access meeting notes, enterprise search functionalities, and content management. This integration enhances the contextual awareness of your applications, allowing for richer, data-driven experiences.",
    "releaseDate": "2026-04-24",
    "capabilities": [
      "Access Fireflies meeting data",
      "Integrate with Gemini Enterprise",
      "Fetch content from WordPress",
      "Use transcripts and summaries in apps",
  ...
  {
    "id": "productivity-app-connectors-google-workspace-microsoft-365",
    "icon": "✨",
    "name": "Productivity app connectors: Google Workspace, Microsoft 365",
    "source": "https://lovable.dev/changelog",
    "status": "Beta",
    "pricing": "All plans",
    "tagline": "Integrate major workplace tools into your applications.",
    "category": "Integrations",
    "useCases": [],
    "description": "Your apps can now connect with Google Workspace and Microsoft 365, allowing you to automate workflows across documents, emails, calendars, and presentations, enhancing the productivity of your applications.",
    "releaseDate": "2026-04-24",
    "capabilities": [
      "Access Gmail and Drive",
      "Automate tasks with Docs and Sheets",
  ...
  },
  {
    ...
    "description": "Productivity Connectors give Lovable apps native access to Google Workspace (Gmail, Drive, Docs) and Microsoft 365 (Outlook, Teams, Word).",
    "releaseDate": "2026-04-24",
    "capabilities": [
  ...
  {
    "id": "app-connectors-aikido-gitlab-and-aws-s3",
    "icon": "✨",
    "name": "App connectors: Aikido, GitLab, and AWS S3",
    "source": "https://lovable.dev/changelog",
    "status": "Beta",
    "pricing": "All plans",
    "tagline": "Integrations for data, security, and developer workflows.",
    "category": "App Connectors",
    "useCases": [],
    "description": "New app connectors for Aikido, GitLab, and AWS S3 allow your apps to interact directly with external platforms for enhanced functionality and workflow automation.",
    "releaseDate": "2026-04-01",
    "capabilities": [
      "AI-powered penetration testing with Aikido",
      "Two-way sync with GitLab",
      "Direct file management with AWS S3",
      "Enhanced security insights",
      "Facilitates collaboration in development",
      "Automates project and deployment workflows"
    ]
  },
  {
  ...
  },
  {
    ...
    "description": "Beta feature: vibe coding levels (L1 through L5) that can be added to your LinkedIn profile as a verified Lovable skill marker.",
    "releaseDate": "2026-02-05",
    "capabilities": [
      "L1–L5 progression",
